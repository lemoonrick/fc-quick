    ...
    <header className="header-nav">
      <div className="header-container">
        ...
        <div className="header-logo-group">
          <img src="/logo.png" alt="FC Quick" className="header-logo-img" />
          <span className="header-tagline">Fact-checks in seconds</span>
        </div>

        {/* Center/Right: Interactive Tabs */}
        {tabs?.length > 0 && (
            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Desktop Framer Motion Pill */}
                  {isActive && (
                    <motion.div
                      layoutId="tab-pill"
                      className="desktop-tab-pill"
                      style={{
                        position: 'absolute',
                        inset: 0,
                        borderRadius: 999,
